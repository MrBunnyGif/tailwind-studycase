...
export default function Home() {
  return (
    <>
      ...
      <h1 className="text-2xl underline decoration-wavy underline-offset-8">qwerty</h1>
      <h1 className="text-xl line-through decoration-double decoration-red-600">qwerty</h1>
